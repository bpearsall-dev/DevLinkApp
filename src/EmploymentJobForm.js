...
const EmploymentJobForm = ({ jobData, onInputChange }) => (
  <div>
    <Grid>
      <Grid.Row>
        <Grid.Column width={2}>
      ...
      <Grid.Row>
        ...
        <Grid.Column width={3}>
          <Form.Input
            ...
            value={jobData.experienceField || ""}
            onChange={onInputChange}
            placeholder="Field e.g. JavaScript"
          />
        </Grid.Column>
        <Grid.Column width={1}>
          <label style={{textAlign: 'center'}}>For at least:</label>
        </Grid.Column>
        <Grid.Column width={3}>
          <Form.Input
            name="experienceDuration"
            value={jobData.experienceDuration || ""}
            onChange={onInputChange}
